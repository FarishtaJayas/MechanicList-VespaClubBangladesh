            ...
            {mechanics.map((items) => {
              return (
                <div className="cardElements">
                  <div className="card text-dark bg- mb-3">
                    <div className="card-header">{items.District}</div>
                    <div className="card-body">
                      <h5 className="card-title">{items.Name}</h5>
                      <h5 className="card-title">{items.Contact}</h5>
                      <div className="editButton">
                      <button type="button" className="btn btn-info">Copy <svg xmlns="http://www.w3.org/2000/svg" width="8" height="8" fill="currentColor" class="bi bi-clipboard" viewBox="0 0 16 16">
